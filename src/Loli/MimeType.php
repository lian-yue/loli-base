...
/*	Author: Moon
/*
/*	Created: UTC 2015-01-01 13:55:13
/*	Updated: UTC 2015-03-22 06:30:58
/*
/* ************************************************************************** */
namespace Loli;
class MimeType{
	...
	public static function get($value, $extension = false) {
		if (!$value) {
			return false;
		}
		$value = strtolower($value);
		if (strpos($value, '/') !== false) {
			if (!$key = array_search($value, self::$all)) {
				return false;
			}
		} else {
			$pattern = [];
			...
			if (!preg_match('/^' . implode('|', $pattern) . '$/is', $value, $matches)) {
				return false;
			}
			unset($matches[0]);
